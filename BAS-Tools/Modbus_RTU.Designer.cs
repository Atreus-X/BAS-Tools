namespace MainApp
{
    partial class Modbus_RTU
    {
        ...
        private void InitializeComponent()
        {
            ...
            var configFrame = new System.Windows.Forms.GroupBox { Text = "Modbus RTU Configuration", Dock = System.Windows.Forms.DockStyle.Top, Height = 130, Padding = new System.Windows.Forms.Padding(10) };
            ...
            var configLayout = new System.Windows.Forms.TableLayoutPanel { Dock = System.Windows.Forms.DockStyle.Fill, ColumnCount = 4, RowCount = 3 };
            ...
            int row = 0;
            configLayout.Controls.Add(new System.Windows.Forms.Label { Text = "Serial Port:", Anchor = System.Windows.Forms.AnchorStyles.Left, AutoSize = true }, 0, row);
            ...
            configLayout.Controls.Add(this.serialPortComboBox, 1, row);

            configLayout.Controls.Add(new System.Windows.Forms.Label { Text = "Baud Rate:", Anchor = System.Windows.Forms.AnchorStyles.Left, AutoSize = true }, 2, row);
            ...
            configLayout.Controls.Add(this.baudRateComboBox, 3, row++);

            configLayout.Controls.Add(new System.Windows.Forms.Label { Text = "Data Bits:", Anchor = System.Windows.Forms.AnchorStyles.Left, AutoSize = true }, 0, row);
            ...
            configLayout.Controls.Add(this.dataBitsComboBox, 1, row);

            configLayout.Controls.Add(new System.Windows.Forms.Label { Text = "Parity:", Anchor = System.Windows.Forms.AnchorStyles.Left, AutoSize = true }, 2, row);
            this.parityComboBox = new System.Windows.Forms.ComboBox { Dock = System.Windows.Forms.DockStyle.Fill, DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList };
            configLayout.Controls.Add(this.parityComboBox, 3, row++);

            configLayout.Controls.Add(new System.Windows.Forms.Label { Text = "Stop Bits:", Anchor = System.Windows.Forms.AnchorStyles.Left, AutoSize = true }, 0, row);
            this.stopBitsComboBox = new System.Windows.Forms.ComboBox { Dock = System.Windows.Forms.DockStyle.Fill, DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList };
            configLayout.Controls.Add(this.stopBitsComboBox, 1, row);

            configLayout.Controls.Add(new System.Windows.Forms.Label { Text = "Unit ID:", Anchor = System.Windows.Forms.AnchorStyles.Left, AutoSize = true }, 2, row);
            this.unitIdComboBox = new System.Windows.Forms.ComboBox { Dock = System.Windows.Forms.DockStyle.Fill };
            configLayout.Controls.Add(this.unitIdComboBox, 3, row++);

            this.connectButton = new System.Windows.Forms.Button { Text = "Connect", Width = 80, Height = 25 };
            configLayout.Controls.Add(this.connectButton, 2, row); // Moved to row 3, col 2
            this.disconnectButton = new System.Windows.Forms.Button { Text = "Disconnect", Width = 80, Height = 25 };
            configLayout.Controls.Add(this.disconnectButton, 3, row); // Moved to row 3, col 3
